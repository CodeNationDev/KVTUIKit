...
extension UIFont {
    ...
    public class func kidSans(size: CGFloat) -> UIFont {
       let fontName: String = "MyKidsHandwrittenBasic"
        registerFont(withFilenameString: "\(fontName).otf", bundle: Bundle.module)
...
internal extension UIFont {
    ...
    static func registerFont(withFilenameString filenameString: String, bundle: Bundle) {
        ...
        if CTFontManagerRegisterGraphicsFont(font, &errorRef) == false {
            SimplyLogger.trace(str: "UIFont+: this font is already registered in the main bundle.")
        }
    }
}
